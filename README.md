...
- 2026-09-12 · Visual register is an institutional research note: Source Serif 4 headings, Source Sans 3 text/data, Source Code Pro ids; navy accent (#245696 / #4f8fd6 dark, validated with the dataviz palette checker), square corners, hairline and double rules, numbered sections, masthead metadata, "Important information" block. Placeholder notice is a discreet bar, not an alert.
