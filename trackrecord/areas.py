...
AREAS = {
    "passive": ("Passive portfolios", "/passive",
    ...
    "external": ("External managers", "/external",
...
def tool_cards() -> dict[str, list[dict]]:
    ...
    if risk.get("factors"):
        cards["active"].append(dict(href="/research/risk-model", eyebrow="Risk model",
    ...
    if rv.get("managers"):
        cards["active"].append(dict(href="/research/r-verify", eyebrow="Verification in R",
    ...
    if idx.get("benchmark"):
        cards["passive"].append(dict(href="/research/index-tracker", eyebrow="Index tracking",
            title=f"Replicate {idx['benchmark']} with fewer names",
    ...
    cards["external"].append(dict(href="/f/appaloosa/memo", eyebrow="Due diligence",
    ...
    if sig and sigman:
        ...
        cards["external"].append(dict(href="/research/13f-signals", eyebrow="Signal research",
