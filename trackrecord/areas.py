...
def home_html(page, n_managers: int, n_scorable: int) -> str:
    ...
    return page("Portfolio Verification Tracker", CARD_CSS + f"""<div class="banner"><b>Public data.</b> Every tool runs on public information: managers' quarterly holdings filings, listed funds' prices and the standard academic market factors. Nothing here is investment advice.</div>
<header class="cover"><div class="cover-in"><div class="eyebrow">Quantitative portfolio management · global equity</div><div class="rule"></div><h1>Portfolio Verification Tracker</h1>
